...
fn action_help() -> Vec<&'static str> {
    vec![
        ...
        "brace           - Brace against a telegraphed floor event",
        "intercept       - Delay and weaken a telegraphed floor event",
        "embrace         - Accept a floor event immediately for Concert Energy",
        "purify          - Consume Cleanse Remedy to cancel a modifier surge",
        "bolster         - Consume Aegis Elixir to weaken a mini-boss incursion",
        "channel         - Consume Healing Potion to convert a Healing Surge",
